About terraform-provider-tls-feedstock
======================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/terraform-provider-tls-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/terraform-provider-tls-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add terraform-provider-tls
# for installing globally
pixi global install terraform-provider-tls
```
...
It is possible to list all of the versions of `terraform-provider-tls` available on your platform:
...
```
pixi search terraform-provider-tls --channel conda-forge
```
